...
set "MSI_FILE=%INSTALLER_DIR%\NexusControlAgent-Setup-v0.11.5-win-x64.msi"
set "LOCALIZED_MSI_FILE=%INSTALLER_DIR%\de-DE\NexusControlAgent-Setup-v0.11.5-win-x64.msi"
