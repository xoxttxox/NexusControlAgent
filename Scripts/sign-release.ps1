...
$msiPath = Join-Path $projectRoot "artifacts\installer\NexusControlAgent-Setup-v0.11.0-win-x64.msi"
$localizedMsiPath = Join-Path $projectRoot "artifacts\installer\de-DE\NexusControlAgent-Setup-v0.11.0-win-x64.msi"
