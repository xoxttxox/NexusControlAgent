...
Assert-True ($productVersion -like '0.10.3*') "Unerwartete Agent-Version: $productVersion"
...
Write-Host 'Nexus Control Agent 0.10.3 ist korrekt ohne Windows-Entsperrfunktion installiert.' -ForegroundColor Green
